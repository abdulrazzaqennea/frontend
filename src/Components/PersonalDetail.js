...
const Register=()=> {
  ...
  const updateDetails = (e)=>{
    ...
    const getSingleUserDetails=()=>{
      getUserDetails(formValues.business,formValues.password).then((Response)=>{
    ...
    <div className="container">
      <form>
        ...
        <div className="ui form">
          ...
          {isEdit && <button className="fluid ui button blue" onClick={updateDetails}>Update</button>}
          {!isEdit && <button className="fluid ui button blue" onClick={handleSubmit}>Edit</button>}
        </div>
      </form>
    </div>
  );
